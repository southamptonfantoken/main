...
const sttaddr = "0x9665e5a3d27690228350032c70ad77f8674a3f8c";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x9665e5a3d27690228350032c70ad77f8674a3f8c";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://southamptonfantoken.com?ref=' + document.getElementById('refaddress').value;
        }
    }
}
